                ...
                <div id="left">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            Tel:<a style="text-decoration: none" href="tel:12345">12345</a><br>
                            Email:<a style="text-decoration: none" href="mailto:your-email@your-email.com">your-email@your-email.com</a>
                        </div>
                        <div class="col-6">
                            <h5>Opening hours:</h5>
                            <p>
                    ...
                    <div class="footer-copyright text-center py-3 float-right">
                            <nav>
                                <ul class="pagination pagination-sm">
                                    ...
                                    <li class="page-item disabled"><a class="page-link">9<a/></li>
